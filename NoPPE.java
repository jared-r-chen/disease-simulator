import java.util.*;
  ...
  */
public class NoPPE extends Disease{

  public NoPPE(double rate, String name){
    super(rate, name);
  }
   ...
   /**
    * @Override
    * update: looks at a node and if it is infected it will look at all of the nodes connected to the current node. Then, based on infection rate and edge weight, update will infect neighboring nodes. However, in this subclass, infection rate is increased to reflect no PPE.
